...
class PlaceSelectRecyclerAdapter(val mContext: Context, val mList: ArrayList<PlaceData>) :
    RecyclerView.Adapter<PlaceSelectRecyclerAdapter.PlaceViewHolder>() {
...
//    인터페이스를 변수로 설정
    ...
    //    null : 아이템 클릭시 할 일이 없다.
//    null 아니다 : 할일이 지정된 상태가 아니다.
