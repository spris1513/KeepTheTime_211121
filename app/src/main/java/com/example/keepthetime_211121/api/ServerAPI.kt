...
//                우리가 지정한 양식의 String이 온다면 > Date 형태로 변환해주는 세팅 추가.
//                파싱에 대한 세팅 추가 > 파싱전담 : gson이 담당 > gson에 대한 세팅
...
//                 비어있는 retrofit 객체 생성
                ...
                retrofit = Retrofit.Builder()
                    .baseUrl(BASE_URL)
                    .client(myClient)
                    .addConverterFactory(GsonConverterFactory.create(gson)) // Date 를 자동으로 파싱하는 도구를 Retrofit에 등록
                    .build()
